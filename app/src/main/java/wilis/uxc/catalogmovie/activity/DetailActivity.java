package com.omrobbie.cataloguemovieuiux.activity;
...
public class DetailActivity extends AppCompatActivity {
    ...
    @BindView(R.id.img_poster_belongs) ImageView img_poster_belongs;

    @BindView(R.id.tv_title_belongs) TextView tv_title_belongs;

    @BindView(R.id.tv_budget) TextView tv_budget;

    @BindView(R.id.tv_revenue) TextView tv_revenue;

    @BindView(R.id.tv_companies) TextView tv_companies;

    @BindView(R.id.tv_countries) TextView tv_countries;

    @BindView(R.id.iv_fav) ImageView iv_fav;
